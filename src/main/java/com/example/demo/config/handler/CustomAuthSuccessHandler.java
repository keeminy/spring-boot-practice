...
//                JSONObject userVoObj = (JSONObject)mapper.writeValueAsString(user);
...
//		ObjectMapper mapper = new ObjectMapper();
		...
		printWriter.print(objectMapper.writeValueAsString(responseMap)); // 최종 저장된 '사용자 정보', '사이트 정보' Front 전달
		printWriter.flush();
		printWriter.close();
	}
}
